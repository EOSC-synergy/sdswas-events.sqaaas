...
#
#  $ bin/test -s sdswas.events -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src sdswas.events.testing.SDSWAS_EVENTS_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/sdswas/events/tests/robot/test_example.robot
#
